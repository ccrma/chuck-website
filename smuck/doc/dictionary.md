...
<div style="text-align: center;">
  <img src="../img/scales/ionian.svg" alt="Alt text" width="60%">
  <p style="font-style: italic;">Ionian mode: <code>"ionian"</code></p>
</div>
<div style="text-align: center;">
  <img src="../img/scales/dorian.svg" alt="Alt text" width="60%">
  <p style="font-style: italic;">Dorian mode: <code>"dorian"</code></p>
</div>
<div style="text-align: center;">
  <img src="../img/scales/phrygian.svg" alt="Alt text" width="60%">
  <p style="font-style: italic;">Phrygian mode: <code>"phrygian"</code></p>
</div>
<div style="text-align: center;">
  <img src="../img/scales/lydian.svg" alt="Alt text" width="60%">
  <p style="font-style: italic;">Lydian mode: <code>"lydian"</code></p>
</div>
<div style="text-align: center;">
  <img src="../img/scales/mixolydian.svg" alt="Alt text" width="60%">
  <p style="font-style: italic;">Mixolydian mode: <code>"mixolydian"</code></p>
</div>
<div style="text-align: center;">
  <img src="../img/scales/aeolian.svg" alt="Alt text" width="60%">
  <p style="font-style: italic;">Aeolian mode: <code>"aeolian"</code></p>
</div>
<div style="text-align: center;">
  <img src="../img/scales/locrian.svg" alt="Alt text" width="60%">
...
<div style="text-align: center;">
  <img src="../img/scales/major-harmonic.svg" alt="Alt text" width="60%">
...
<div style="text-align: center;">
  <img src="../img/chords/maj.svg" alt="Alt text" width="20%">
  <p style="font-style: italic;">Major triad: <code>"maj"</code></p>
</div>
<div style="text-align: center;">
  <img src="../img/chords/min.svg" alt="Alt text" width="20%">
  <p style="font-style: italic;">Minor triad: <code>"min"</code></p>
</div>
<div style="text-align: center;">
  <img src="../img/chords/dim.svg" alt="Alt text" width="20%">
  <p style="font-style: italic;">Diminished triad: <code>"dim"</code></p>
</div>
<div style="text-align: center;">
  <img src="../img/chords/aug.svg" alt="Alt text" width="20%">
  <p style="font-style: italic;">Augmented triad: <code>"aug"</code></p>
</div>
<div style="text-align: center;">
  <img src="../img/chords/sus.svg" alt="Alt text" width="20%">
...
<div style="text-align: center;">
  <img src="../img/chords/maj6.svg" alt="Alt text" width="20%">
  <p style="font-style: italic;">Major 6th chord: <code>"maj6" or just "6"</code></p>
</div>

<div style="text-align: center;">
  <img src="../img/chords/min6.svg" alt="Alt text" width="20%">
...
<div style="text-align: center;">
  <img src="../img/chords/alt7.svg" alt="Alt text" width="20%">
